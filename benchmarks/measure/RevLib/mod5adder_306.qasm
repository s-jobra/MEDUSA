...
ccx qubits[5], qubits[8], qubits[14];
...
ccx qubits[2], qubits[25], qubits[27];
ccx qubits[1], qubits[4], qubits[28];
cx qubits[4], qubits[28];
cx qubits[0], qubits[29];
cx qubits[12], qubits[29];
ccx qubits[0], qubits[28], qubits[29];
ccx qubits[0], qubits[12], qubits[29];
ccx qubits[3], qubits[29], qubits[30];
cx qubits[29], qubits[30];
ccx qubits[0], qubits[28], qubits[31];
cx qubits[0], qubits[31];
cx qubits[31], qubits[11];
ccx qubits[3], qubits[11], qubits[31];
cx qubits[31], qubits[30];
ccx qubits[2], qubits[30], qubits[31];
x qubits[31];
