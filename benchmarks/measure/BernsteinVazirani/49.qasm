...
cx qubits[32], qubits[49];
cx qubits[34], qubits[49];
cx qubits[36], qubits[49];
cx qubits[38], qubits[49];
cx qubits[40], qubits[49];
cx qubits[42], qubits[49];
cx qubits[44], qubits[49];
cx qubits[46], qubits[49];
