...
cx qubits[64], qubits[82];
cx qubits[66], qubits[82];
cx qubits[68], qubits[82];
cx qubits[70], qubits[82];
cx qubits[72], qubits[82];
cx qubits[74], qubits[82];
cx qubits[76], qubits[82];
cx qubits[78], qubits[82];
cx qubits[80], qubits[82];
h qubits[0];
h qubits[1];
h qubits[2];
h qubits[3];
